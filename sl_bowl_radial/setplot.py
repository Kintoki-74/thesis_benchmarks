...
#--------------------------
    ...
    #-----------------------------------------
    plotfigure = plotdata.new_plotfigure(name='cross-section', figno=123)

    # Set up for axes in this figure:
    plotaxes = plotfigure.new_plotaxes()
    plotaxes.xlimits = [-100.,100.]
    plotaxes.ylimits = [-15.,30.]
    ...
    def plot_topo_xsec(current_data):
        ...
        B = x*0.-10.
        #B = where(np.sqrt((x-2.)*(x-2.) + (y-2.)*(y-2.)) < 20., -10., -13.)
        ...
        #plot([0],[-1],'r',label="Computed")  ## need to fix plotstyle
        plot([0],[-1],'r-',label="Computed")  ## need to fix plotstyle
        legend()
        hold(False)
    ...
    plotdata.print_gaugenos = [0, 10]         # list of gauges to print
    #plotdata.print_fignos = 'all'            # list of figures to print
    plotdata.print_fignos = [0,123]            # list of figures to print
